Shader "AVProVideo/Skybox/Sphere_WebGL"
{
	Properties
	{
	...
	SubShader
	{
		...
		half4 frag(v2f i) : SV_Target
		{
			...
			bool isSquareTexture = (aspectRatio > 0.99 && aspectRatio < 1.01); // check aspect ratio for squared (usually tereoscopic) textures
			if (isSquareTexture)
		    {
		        // only use upper half of texture
		        tc.y *= 0.5;
		    }
